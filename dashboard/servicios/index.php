...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerServicios(),4);
...
<h3><?php echo $plural; ?></h3>
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox">
        	...
        	<div class="row">
			<h4 style="margin-left:15px;"><span class="glyphicon glyphicon-info-sign"></span> Recuerde que el Tiempo se carga en "Minutos"</h4>
			<hr>
			<?php echo $formulario; ?>
            </div>
